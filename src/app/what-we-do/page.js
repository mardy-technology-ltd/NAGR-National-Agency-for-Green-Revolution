...
export const metadata = {
  title: 'What We Do | NAGR Bangladesh',
  description: 'Explore NAGR Bangladesh core development projects across Multilingual Education, Maternal Health, and Economic Empowerment.',
};
      ...
      <section className="py-12 bg-[#040905] border-b border-emerald-900/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white">
            What We <span className="text-gradient-emerald">Do</span>
          </h1>
          <p className="text-emerald-200/80 text-sm max-w-2xl mx-auto">
            From pre-primary multilingual schools and youth hostels to 24/7 community hospitals and micro-savings cooperatives.
          </p>
        </div>
      </section>
